...
TARGET_NAME      := finalproject
BOARD_ID         := TEENSY31

MCU              := mk20dx256

LIBS_SHARED_BASE := C:\Users\Marcus\Documents\Arduino\libraries
LIBS_SHARED      := 

LIBS_LOCAL_BASE  := lib
LIBS_LOCAL       := Wire 

CORE_BASE        := D:\Arduino\hardware\teensy\avr\cores\teensy3
GCC_BASE         := D:\Arduino\hardware\tools\arm
UPL_PJRC_B       := D:\Arduino\hardware\tools
UPL_TYCMD_B      := 
UPL_CLICMD_B     := 
